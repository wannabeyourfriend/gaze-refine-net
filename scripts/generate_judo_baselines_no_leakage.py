...
if __name__ == '__main__':
    generate_baselines_for_split(
        train_path='data/prepared/judo_1000_split_no_leakage/train.csv',
        val_path='data/prepared/judo_1000_split_no_leakage/val.csv',
        test_path='data/prepared/judo_1000_split_no_leakage/test.csv',
        output_dir='data/prepared/judo_1000_split_no_leakage'
    )
