...
def main():
    ...
    # 数据路径
    data_path = Path('/Users/admin/Codebase/NRMBC-Neural-Refined-Model-Based-Gazing-Point-Calibration/data/raw/all/all_trials_model_predictions_0111.csv')
    output_path = Path('/Users/admin/Codebase/NRMBC-Neural-Refined-Model-Based-Gazing-Point-Calibration/apps/figuring/eyeball_gaze_visualization.png')
